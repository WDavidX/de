...
;; Author: Benjamin Rutt <[EMAIL PROTECTED]>
;; Version: 1.3.2
;; Last revised by: Weichao David Xu
...
(defvar backup-each-save-size-limit 500
...
(defun backup-each-save ()
  ;; (let ((bfn (buffer-file-name)))
	  (let ((bfn  (file-name-nondirectory (buffer-file-name)))) ;; file name w/o ext
